...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Take the Revital Readiness Challenge. Play 3 fast games, score your energy, win prizes worth 100K AED." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Revital Energy Challenge — Are You Ready?" },
      { name: "twitter:description", content: "Take the Revital Readiness Challenge. Play 3 fast games, score your energy, win prizes worth 100K AED." },
