                ...
                >
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-3 xl:grid-cols-5 gap-3 mt-4">
                    ...
                    <KpiCard
                      ...
                      onClick={() => topReferrersRef.current?.scrollIntoView({ behavior: "smooth", block: "start" })}
                    />
                  </div>
                  ...
                  {stats.topReferrers.length > 0 && (
                    <div ref={topReferrersRef} className="mt-5 bg-gradient-card border border-border rounded-3xl p-5 shadow-card">
